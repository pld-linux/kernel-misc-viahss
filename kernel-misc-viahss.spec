...
VIA High Speed Serial to mały moduł jądra (1kB) włączający szybkie
tryby pracy portu szeregowego wbudowanego w płyty główne z mostkiem
południowym VIA VT82C686A lub VT82C686B. Przy pomocy tego modułu można
używać portu szeregowego z prędkością 230400 bit/s, co pozwala na
...
modułu można używać portu szeregowego z prędkością 230400 bit/s, co
pozwala na uzyskanie pełnego transferu 128000 bit/s w komunikacji z
